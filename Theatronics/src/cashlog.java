...
public class cashlog {
	...
	public static int emp=-1;
	  ...
	  private static cashlog instance =  new cashlog();
		
		public static  cashlog getInstance() {
			return instance;
		}
	  public void initialize() {
	   ...
	   public void onButtonClicked(ActionEvent e) throws IOException, NumberFormatException, SQLException {
	    	if(e.getSource().equals(sButton)) {
	    		...
	    		if(PersonData.getInstance().retrievecash(Integer.valueOf(uField.getText()), pField.getText()))            
	    	     {
	    			Stage p = (Stage) uField.getScene().getWindow();
	    			FXMLLoader loader = new FXMLLoader(Cinema.class.getResource("cashier.fxml"));
	    	    	AnchorPane root =  loader.load();
	    	   		emp = Integer.valueOf(uField.getText());
